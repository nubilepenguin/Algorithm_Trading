...
RISK_LIMIT_MAX_TRADE_VOLUME = 4000 * 1.5
...
for close_price in close:
    ...
    if (not risk_violated and
            ((apo > APO_VALUE_FOR_SELL_ENTRY * stdev_factor and abs(
                close_price - last_sell_price) > MIN_PRICE_MOVE_FROM_LAST_TRADE * stdev_factor)
             or

...
ema_fast_values = [] # track fast EMA values for visualization purpose
ema_slow_values = [] # track slow EMA values for visualization purpose
macd_values = [] # track MACD values for visualization purpose
macd_signal_values = [] # MACD EMA values tracker
macd_histogram_values = [] # MACD - MACD_ema
...
for close_price in close:
    ...
    macd = ema_fast - ema_slow # MACD is fast_MA - slow_MA
    if ema_macd == 0:
        ema_macd = macd
    else:
